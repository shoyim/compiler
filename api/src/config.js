...
const options = {
    ...
    compile_timeout: { default: 10000, parser: parseInt, validators: [(x, raw) => !isNaN(x)] },
    run_timeout: { default: 10000, parser: parseInt, validators: [(x, raw) => !isNaN(x)] },
    compile_cpu_time: { default: 10000, parser: parseInt, validators: [(x, raw) => !isNaN(x)] },
