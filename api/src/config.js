...
const options = {
    ...
    output_max_size: { default: 104857600, parser: parseInt, validators: [(x, raw) => !isNaN(x)] },
    ...
    compile_timeout: { default: 600000, parser: parseInt, validators: [(x, raw) => !isNaN(x)] },
    run_timeout: { default: 600000, parser: parseInt, validators: [(x, raw) => !isNaN(x)] },
    compile_cpu_time: { default: 600000, parser: parseInt, validators: [(x, raw) => !isNaN(x)] },
    run_cpu_time: { default: 100000, parser: parseInt, validators: [(x, raw) => !isNaN(x)] },
    compile_memory_limit: { default: -1, parser: parseInt, validators: [(x, raw) => !isNaN(x)] },
    run_memory_limit: { default: 1000000000, parser: parseInt, validators: [(x, raw) => !isNaN(x)] },
